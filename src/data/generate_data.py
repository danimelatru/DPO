...
def generate_search_query():
    ...
    companies = [
        "Tesla", "Apple", "Google", "Meta", "Microsoft", "Amazon", "NVIDIA", 
        "OpenAI", "SpaceX", "Netflix", "Samsung", "Intel", "IBM", "Oracle",
        "Salesforce", "Adobe", "Shopify", "Twitter", "Uber", "Airbnb",
        "PayPal", "Stripe", "Zoom", "Spotify", "Pinterest", "Reddit",
        "TikTok", "LinkedIn", "Dropbox", "Slack", "Discord", "GitHub"
    ]
    
    cities = [
        "London", "Paris", "Tokyo", "New York", "Berlin", "Madrid", 
        "Rome", "Sydney", "Toronto", "Dubai", "Singapore", "Barcelona",
        "Amsterdam", "Vienna", "Stockholm", "Copenhagen", "Zurich",
        "Prague", "Budapest", "Warsaw", "Athens", "Lisbon", "Dublin",
        "Edinburgh", "Brussels", "Oslo", "Helsinki", "Munich", "Milan",
        "Venice", "Florence", "Chicago", "Los Angeles", "San Francisco"
    ]
    
    topics = [
        "AI", "climate change", "electric vehicles", "space exploration", 
        "quantum computing", "renewable energy", "blockchain", "5G networks",
        "cryptocurrency", "machine learning", "robotics", "biotechnology",
        "nanotechnology", "virtual reality", "augmented reality", "IoT",
        "cybersecurity", "cloud computing", "edge computing", "metaverse"
    ]
    
    people = [
        "Einstein", "Marie Curie", "Steve Jobs", "Elon Musk", "Ada Lovelace",
        "Tim Berners-Lee", "Grace Hopper", "Alan Turing", "Isaac Newton",
        "Galileo", "Darwin", "Tesla", "Edison", "Bill Gates", "Mark Zuckerberg",
        "Jeff Bezos", "Warren Buffett", "Oprah Winfrey", "Nelson Mandela",
        "Martin Luther King", "Gandhi", "Shakespeare", "Leonardo da Vinci"
    ]
...
def generate_calendar_query():
    ...
    # Expanded lists
    people = [
        "Mark", "Sarah", "John", "Alice", "David", "Emma", "Michael", 
        "Lisa", "Peter", "Jennifer", "Robert", "Maria", "James", "Anna",
        "Thomas", "Laura", "Daniel", "Sophie", "Chris", "Emily",
        "Andrew", "Kate", "Brian", "Rachel", "Kevin", "Michelle",
        "Steven", "Jessica", "Paul", "Amanda", "Eric", "Nicole"
    ]
    
    days = [
        "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", 
        "next week", "tomorrow", "next Monday", "this Friday",
        "next Tuesday", "this Wednesday", "next Thursday",
        "Saturday", "Sunday", "next month", "today"
    ]
    
    times = [
        "9am", "2pm", "5pm", "noon", "3:30pm", "10am", "4pm", "11am",
        "1pm", "8am", "6pm", "7pm", "8:30am", "3pm", "9:30am",
        "10:30am", "2:30pm", "4:30pm", "midday"
    ]
    
    meetings = [
        "team sync", "client call", "standup", "review meeting", 
        "presentation", "workshop", "brainstorm session", "sprint planning",
        "one-on-one", "board meeting", "product demo", "training session",
        "interview", "performance review", "kickoff meeting", "retrospective",
        "strategy session", "town hall", "coffee chat", "lunch meeting"
    ]
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="data/processed/dpo_data.jsonl",
